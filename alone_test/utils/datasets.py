...
class InfiniteDataLoader(torch.utils.data.dataloader.DataLoader):   #这块对DataLoader进行封装，就是为了能够永久持续的采样数据
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.mosaic = self.augment and not self.rect  # load 4 images at a time into a mosaic (only during training) # 是否启用马赛克增强
